...
1. **Identify Need**: Determine what behavior needs enforcement
2. **Define Scope**: Specify which files/directories the rule applies to
3. **Write Content**: Document enforcement criteria and rationale
4. **Test Application**: Verify rule triggers appropriately
5. **Document Changes**: Update relevant AGENTS.md and README.md files

### Rule Maintenance

1. **Monitor Effectiveness**: Track rule violation patterns
2. **Update Content**: Modify rules as project standards evolve
3. **Version Control**: Rules are versioned with project code
