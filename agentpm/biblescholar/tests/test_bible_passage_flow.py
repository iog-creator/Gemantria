...
class TestFetchVerse:
    ...
    def test_fetch_verse_success(self, mock_adapter_class):
        ...
        mock_adapter.get_verse.assert_called_once_with("Genesis", 1, 1, "KJV")
...
class TestFetchPassage:
    ...
    def test_fetch_passage_range_same_chapter(self, mock_adapter_class):
        ...
        assert len(result) == 3
        mock_adapter.get_passage.assert_called_once_with("Genesis", 1, 1, 1, 3, "KJV")
    ...
    def test_fetch_passage_range_cross_chapter(self, mock_adapter_class):
        ...
        assert len(result) == 3
        mock_adapter.get_passage.assert_called_once_with("Genesis", 1, 31, 2, 2, "KJV")
