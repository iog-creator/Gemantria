# AGENTS.md - agentpm/control_widgets Directory

## Directory Purpose

The `agentpm/control_widgets/` directory contains control_widgets components for the Gematria analysis pipeline.
