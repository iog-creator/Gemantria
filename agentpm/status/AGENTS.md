# AGENTS.md - agentpm/status Directory

## Directory Purpose

The `agentpm/status/` directory contains status components for the Gematria analysis pipeline.
