...
pytestmark = pytest.mark.xfail(strict=False, reason="M2+ determinism TVs (E11-E13) pending implementation")
...
def test_e11_deterministic_with_injected_clock():
    items = [{"i": 1}, {"i": 2}, {"i": 3}]
    a = provenance.stamp_batch(items, "qwen2.5", 7, base_dt=BASE)  # requires new param
