...
from agentpm.plan.fix import build_fix_actions, apply_actions, FixAction, _is_approved_path
...
def test_is_approved_path() -> None:
    ...
    assert _is_approved_path("agentpm/AGENTS.md") is True
