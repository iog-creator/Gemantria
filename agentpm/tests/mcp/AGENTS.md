# AGENTS.md - agentpm/tests/mcp Directory

## Directory Purpose

The `agentpm/tests/mcp/` directory contains tests for MCP (Model Context Protocol) components, including Knowledge MCP foundation tests (PLAN-073 M1).
