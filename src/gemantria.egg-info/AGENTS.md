# AGENTS.md - src/gemantria.egg-info Directory

## Directory Purpose

The `src/gemantria.egg-info/` directory contains gemantria.egg-info components for the Gematria analysis pipeline.
