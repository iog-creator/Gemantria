...
def compare_env_sources() -> None:
    files = [
        ...
        ("env_example.txt", Path("env_example.txt")),
    ]
            ...
            REPORT["conflicts"].append(
                {
                    ...
                    "env": base[k],
                    "env_local": v,
                    "reason": "env_local overrides .env",
                }
            )
    ...
    try:
        ...
        if r.status_code != 200:
            REPORT["lmstudio"] = {
                ...
                "reason": "No /v1/models endpoint — upgrade/enable OpenAI API",
            }
            return
