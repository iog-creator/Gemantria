...
def ingest_nouns():
    ...
    for r in rows:
        ...
        if lemma not in concepts_map:
            ...
            print(
                "🔥🔥🔥 LOUD HINT [data.bible_lemma_english]: Bible DB 'lemma' column contains English definitions. Using surface form for Hebrew text & Gematria. 🔥🔥🔥",
                file=sys.stderr,
            )
            concepts_map[lemma] = {
                "name": lemma,
        ...
        occurrences.append({"lemma": lemma, "book": book, "chapter": chapter, "verse": verse, "position": position})
