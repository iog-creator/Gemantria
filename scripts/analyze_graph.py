    ...
    try:
        ...
        for node, cluster_id in cluster_map.items():
            try:
                ...
                log_json(LOG, 40, "cluster_insert_failed", node=node[:8], cluster_id=cluster_id, error=str(e))
        ...
        result = {
            ...
            "largest_cluster": max([list(cluster_map.values()).count(cid) for cid in set(cluster_map.values())], default=0),
