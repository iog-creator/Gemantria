...
base = {"strict": strict, "checkpointer": ("postgres" if strict else "memory"), "catalog": "mcp_catalog.v1"}
...
chip = {**base, "atlas": {"index": index, "nodes": [node0]}, "generated_at": time.strftime("%Y-%m-%dT%H:%M:%SZ")}
