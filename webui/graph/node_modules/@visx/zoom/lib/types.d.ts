...
import { RefObject, MouseEvent as ReactMouseEvent, TouchEvent as ReactTouchEvent, PointerEvent as ReactPointerEvent, WheelEvent as ReactWheelEvent } from 'react';
...
export declare type PinchDelta = (params: Parameters<Handler<'pinch', TouchEvent | ReactTouchEvent | PointerEvent | ReactPointerEvent | WheelEvent | ReactWheelEvent | WebKitGestureEvent>>[0]) => Scale;
...
export interface ProvidedZoom<ElementType> {
    ...
    dragMove: (event: ReactMouseEvent | ReactTouchEvent | MouseEvent | TouchEvent, options?: {
        offsetX?: number;
        offsetY?: number;
    }) => void;
