...
export declare const updateOrdinalScale: <Output = DefaultOutput, DiscreteInput extends StringLike = StringLike, ThresholdInput extends string | number | Date = string | number | Date>(scale: import("@visx/vendor/d3-scale").ScaleOrdinal<DiscreteInput, Output, never>, config?: Pick<Pick<import("../types/BaseScaleConfig").BaseScaleConfig<"ordinal", DiscreteInput[], Output[]>, "reverse" | "type" | "domain" | "range" | "unknown">, "reverse" | "domain" | "range" | "unknown"> | undefined) => import("@visx/vendor/d3-scale").ScaleOrdinal<DiscreteInput, Output, never>;
