...
export declare const updateTimeScale: <Output = DefaultOutput, DiscreteInput extends import("../types/Base").StringLike = import("../types/Base").StringLike, ThresholdInput extends string | number | Date = string | number | Date>(scale: import("@visx/vendor/d3-scale").ScaleTime<Output, Output, never>, config?: Pick<import("../types/ScaleConfig").TimeScaleConfig<Output>, "reverse" | "domain" | "range" | "clamp" | "interpolate" | "nice" | "round"> | undefined) => import("@visx/vendor/d3-scale").ScaleTime<Output, Output, never>;
export default function createTimeScale<Output = DefaultOutput>(config?: PickScaleConfigWithoutType<'time', Output>): import("@visx/vendor/d3-scale").ScaleTime<Output, Output, never>;
