...
function arc(_temp) {
  ...
  var path2 = arc_default();
  if (innerRadius != null)
    setNumberOrNumberAccessor(path2.innerRadius, innerRadius);
  if (outerRadius != null)
    setNumberOrNumberAccessor(path2.outerRadius, outerRadius);
  if (cornerRadius != null)
    setNumberOrNumberAccessor(path2.cornerRadius, cornerRadius);
  if (startAngle != null)
    setNumberOrNumberAccessor(path2.startAngle, startAngle);
  if (endAngle != null)
    setNumberOrNumberAccessor(path2.endAngle, endAngle);
  if (padAngle != null)
    setNumberOrNumberAccessor(path2.padAngle, padAngle);
  if (padRadius != null)
    setNumberOrNumberAccessor(path2.padRadius, padRadius);
  return path2;
}
function area(_temp2) {
  ...
  if (x0)
    setNumberOrNumberAccessor(path2.x0, x0);
  if (x1)
    setNumberOrNumberAccessor(path2.x1, x1);
  if (y2)
    setNumberOrNumberAccessor(path2.y, y2);
  if (y0)
    setNumberOrNumberAccessor(path2.y0, y0);
  if (y1)
    setNumberOrNumberAccessor(path2.y1, y1);
  if (defined)
...
function radialLine(_temp5) {
  ...
  var path2 = lineRadial_default();
  if (angle)
    setNumberOrNumberAccessor(path2.angle, angle);
  if (radius)
    setNumberOrNumberAccessor(path2.radius, radius);
  if (defined)
    path2.defined(defined);
  if (curve)
    path2.curve(curve);
...
function stack(_ref6) {
  ...
  var path2 = stack_default();
  if (keys)
    path2.keys(keys);
  if (value)
    setNumberOrNumberAccessor(path2.value, value);
  if (order)
    path2.order(stackOrder(order));
  if (offset)
    path2.offset(stackOffset(offset));
  return path2;
}
...
function AreaClosed(_ref) {
  ...
  if (y2 && !y1)
    setNumberOrNumberAccessor(path2.y1, y2);
  if (y1 && !y2)
    setNumberOrNumberAccessor(path2.y1, y1);
  if (children)
...
function BarGroup(_ref) {
  ...
  if (children)
    return import_react12.default.createElement(import_react12.default.Fragment, null, children(barGroups));
...
function BarGroupHorizontal(_ref) {
  ...
  if (children)
    return import_react13.default.createElement(import_react13.default.Fragment, null, children(barGroups));
...
function BarStack(_ref) {
  ...
  if (children)
    return import_react14.default.createElement(import_react14.default.Fragment, null, children(barStacks));
...
function BarStackHorizontal(_ref) {
  ...
  if (children)
    return import_react15.default.createElement(import_react15.default.Fragment, null, children(barStacks));
...
function LinkHorizontalDiagonal(_ref2) {
  var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path2 = _ref2.path, _ref2$x = _ref2.x, x2 = _ref2$x === void 0 ? getY : _ref2$x, _ref2$y = _ref2.y, y2 = _ref2$y === void 0 ? getX : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose16(_ref2, _excluded16);
...
function LinkVerticalDiagonal(_ref2) {
  var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path2 = _ref2.path, _ref2$x = _ref2.x, x2 = _ref2$x === void 0 ? getX : _ref2$x, _ref2$y = _ref2.y, y2 = _ref2$y === void 0 ? getY : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose17(_ref2, _excluded17);
...
function LinkRadialDiagonal(_ref2) {
  var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path2 = _ref2.path, _ref2$angle = _ref2.angle, angle = _ref2$angle === void 0 ? getX : _ref2$angle, _ref2$radius = _ref2.radius, radius = _ref2$radius === void 0 ? getY : _ref2$radius, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose18(_ref2, _excluded18);
...
function LinkHorizontalCurve(_ref2) {
  var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path2 = _ref2.path, _ref2$percent = _ref2.percent, percent = _ref2$percent === void 0 ? 0.2 : _ref2$percent, _ref2$x = _ref2.x, x2 = _ref2$x === void 0 ? getY : _ref2$x, _ref2$y = _ref2.y, y2 = _ref2$y === void 0 ? getX : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose19(_ref2, _excluded19);
...
function LinkVerticalCurve(_ref2) {
  var className = _ref2.className, children = _ref2.children, data = _ref2.data, innerRef = _ref2.innerRef, path2 = _ref2.path, _ref2$percent = _ref2.percent, percent = _ref2$percent === void 0 ? 0.2 : _ref2$percent, _ref2$x = _ref2.x, x2 = _ref2$x === void 0 ? getX : _ref2$x, _ref2$y = _ref2.y, y2 = _ref2$y === void 0 ? getY : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose20(_ref2, _excluded20);
...
function LinkHorizontalLine(_ref2) {
  var className = _ref2.className, children = _ref2.children, innerRef = _ref2.innerRef, data = _ref2.data, path2 = _ref2.path, _ref2$x = _ref2.x, x2 = _ref2$x === void 0 ? getY : _ref2$x, _ref2$y = _ref2.y, y2 = _ref2$y === void 0 ? getX : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, restProps = _objectWithoutPropertiesLoose22(_ref2, _excluded22);
...
function LinkVerticalLine(_ref2) {
  var className = _ref2.className, innerRef = _ref2.innerRef, data = _ref2.data, path2 = _ref2.path, _ref2$x = _ref2.x, x2 = _ref2$x === void 0 ? getX : _ref2$x, _ref2$y = _ref2.y, y2 = _ref2$y === void 0 ? getY : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, children = _ref2.children, restProps = _objectWithoutPropertiesLoose23(_ref2, _excluded23);
...
function LinkHorizontalStep(_ref2) {
  var className = _ref2.className, innerRef = _ref2.innerRef, data = _ref2.data, path2 = _ref2.path, _ref2$percent = _ref2.percent, percent = _ref2$percent === void 0 ? 0.5 : _ref2$percent, _ref2$x = _ref2.x, x2 = _ref2$x === void 0 ? getY : _ref2$x, _ref2$y = _ref2.y, y2 = _ref2$y === void 0 ? getX : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, children = _ref2.children, restProps = _objectWithoutPropertiesLoose25(_ref2, _excluded25);
  ...
  if (children)
    return import_react25.default.createElement(import_react25.default.Fragment, null, children({
      path: pathGen
    }));
...
function LinkVerticalStep(_ref2) {
  var className = _ref2.className, innerRef = _ref2.innerRef, data = _ref2.data, path2 = _ref2.path, _ref2$percent = _ref2.percent, percent = _ref2$percent === void 0 ? 0.5 : _ref2$percent, _ref2$x = _ref2.x, x2 = _ref2$x === void 0 ? getX : _ref2$x, _ref2$y = _ref2.y, y2 = _ref2$y === void 0 ? getY : _ref2$y, _ref2$source = _ref2.source, source = _ref2$source === void 0 ? getSource : _ref2$source, _ref2$target = _ref2.target, target = _ref2$target === void 0 ? getTarget : _ref2$target, children = _ref2.children, restProps = _objectWithoutPropertiesLoose26(_ref2, _excluded26);
