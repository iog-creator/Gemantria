...
function $() {
  for (var n2, u2, t3, r2, o2, f2, c5, s2 = 1; i.length; )
...
function L(n2, l2, u2, t3) {
  ...
  if (null === c5 && null == n2.key || s2 && e2 == c5.key && f2 == c5.type)
    return u2;
  if (t3 > (s2 ? 1 : 0)) {
    for (i2 = u2 - 1, r2 = u2 + 1; i2 >= 0 || r2 < l2.length; )
      if (null != (c5 = l2[o2 = i2 >= 0 ? i2-- : r2++]) && 0 == (2 & c5.__u) && e2 == c5.key && f2 == c5.type)
        return o2;
  }
  return -1;
}
...
function O(n2, u2, t3, i2, r2, o2, e2, f2, c5, s2) {
  ...
  n:
    if ("function" == typeof j2)
      ...
      null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = q(t3.__e, u2, t3, i2, r2, o2, e2, c5, s2);
...
function q(u2, t3, i2, r2, o2, e2, f2, c5, s2) {
  ...
  if (null == x3)
    ...
    if (e2 = e2 && n.call(u2.childNodes), b = i2.props || p, !c5 && null != e2)
    ...
    if (h2)
      c5 || v2 && (h2.__html == v2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t3.__k = [];
    else if (v2 && (u2.innerHTML = ""), I("template" == t3.type ? u2.content : u2, w(y3) ? y3 : [y3], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && S(i2, 0), c5, s2), null != e2)
      for (a3 = e2.length; a3--; )
        g(e2[a3]);
