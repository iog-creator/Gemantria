# AGENTS.md - pmagent/runtime Directory

## Directory Purpose

The `pmagent/runtime/` directory contains runtime components for LM Studio integration with control-plane logging and AI tracking.
...
**Location:** `pmagent/runtime/lm_logging.py`
...
**Behavior:**
- Calls `lm_studio_chat()` from `pmagent/adapters/lm_studio.py`
