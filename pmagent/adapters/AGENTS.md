# AGENTS.md - pmagent/adapters Directory

## Directory Purpose

The `pmagent/adapters/` directory contains adapter components that bridge external services and data sources with the Gematria analysis pipeline. Adapters handle protocol translation, error handling, and hermetic fallbacks.
