#!/usr/bin/env python3
"""Tests for reality check module (pmagent.reality.check)."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from pmagent.reality.check import (
...
@patch("pmagent.reality.check.get_rw_dsn")
@patch("pmagent.reality.check.get_ro_dsn")
@patch("pmagent.reality.check.get_bible_db_dsn")
...
@patch("pmagent.reality.check.compute_control_summary")
...
@patch("pmagent.reality.check.compute_lm_status")
@patch("pmagent.reality.check.check_lm_health")
...
@patch("pmagent.reality.check.load_json_file")
...
@patch("pmagent.reality.check.subprocess.run")
...
@patch("pmagent.reality.check.run_eval_smoke")
@patch("pmagent.reality.check.check_control_plane_exports")
@patch("pmagent.reality.check.check_lm_health_status")
@patch("pmagent.reality.check.check_db_and_control")
@patch("pmagent.reality.check.check_env_and_dsn")
