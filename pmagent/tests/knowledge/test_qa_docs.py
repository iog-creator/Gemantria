...
from pmagent.knowledge.qa_docs import answer_doc_question
...
def test_happy_path(monkeypatch):
    ...
    with patch("pmagent.knowledge.qa_docs.retrieve_doc_sections", side_effect=mock_retrieve):
        with patch("pmagent.knowledge.qa_docs.guarded_lm_call", return_value=mock_lm_result):
