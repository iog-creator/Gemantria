import pytest
import json
from pmagent.guard.impl import GuardError, validate_por, validate_tool_call_p0, guarded_call_p0
from pmagent.gatekeeper.impl import execute_guarded_tool_call_p0
...
def test_guarded_call_p0_missing_por():
    ...
    from pmagent.guard.impl import validate_tool_call_p0, GuardError
...
def test_tv_07_guarded_catalog_call():
    ...
    from pmagent.adapters.mcp_db import catalog_read_ro
    from pmagent.guard.impl import validate_por, validate_tool_call_p0
