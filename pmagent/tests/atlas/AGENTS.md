# AGENTS.md - pmagent/tests/atlas Directory

## Directory Purpose

The `pmagent/tests/atlas/` directory contains Atlas integration tests that validate end-to-end system behavior and readiness gates. These tests ensure the system meets production requirements before deployment and provide comprehensive validation of critical system components.
