...
from pmagent.guarded.gatekeeper import check_session_ttl, validate_por
from pmagent.guarded.violations import (
    ARG_SCHEMA_INVALID,
    FORBIDDEN_TOOL,
    MISSING_POR,
    PROVENANCE_MISMATCH,
...
class GuardShim:
    ...
    def _get_session_data(self) -> Dict[str, Any] | None:
        ...
        from pmagent.control_plane.sessions import get_session
