...
from pmagent.biblescholar.vector_flow import (
    get_db_status,
...
class TestVectorFlow:
    ...
    @patch("pmagent.biblescholar.vector_flow.BibleVectorAdapter")
    @patch("pmagent.biblescholar.vector_flow.parse_reference")
