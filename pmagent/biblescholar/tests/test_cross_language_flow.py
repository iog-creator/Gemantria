...
from pmagent.biblescholar.cross_language_flow import (
    CrossLanguageMatch,
    WordAnalysis,
...
from pmagent.biblescholar.lexicon_flow import WordStudyResult


class TestAnalyzeWordInContext:
    """Test analyze_word_in_context function."""

    @patch("pmagent.biblescholar.cross_language_flow.fetch_word_study")
    @patch("pmagent.biblescholar.cross_language_flow.fetch_lexicon_entry")
    ...
    @patch("pmagent.biblescholar.cross_language_flow.parse_reference")
...
class TestFindCrossLanguageConnections:
    ...
    @patch("pmagent.biblescholar.cross_language_flow.fetch_word_study")
    @patch("pmagent.biblescholar.cross_language_flow.fetch_lexicon_entry")
    @patch("pmagent.biblescholar.cross_language_flow.similar_verses_for_reference")
    @patch("pmagent.biblescholar.cross_language_flow.LexiconAdapter")
    def test_find_connections_success(self, mock_adapter_class, mock_similar, mock_fetch_entry, mock_fetch_study):
        ...
        # Mock similar verses
        from pmagent.biblescholar.vector_adapter import VerseSimilarityResult
    ...
    def test_find_connections_without_reference(self, mock_adapter_class, mock_fetch_study, mock_fetch_entry):
        ...
        with patch("pmagent.biblescholar.cross_language_flow.similar_verses_for_reference") as mock_similar:
            mock_similar.return_value = []
