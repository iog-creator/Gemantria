...
from pmagent.biblescholar.bible_db_adapter import VerseRecord
from pmagent.biblescholar.gematria_flow import VerseGematriaSummary
from pmagent.biblescholar.reference_slice import ReferenceAnswerResult, answer_reference_question
from pmagent.biblescholar.vector_flow import VerseSimilarityResult


class TestAnswerReferenceQuestion:
    """Test answer_reference_question function."""

    @patch("pmagent.biblescholar.reference_slice.guarded_lm_call")
    @patch("pmagent.biblescholar.reference_slice.similar_verses_for_reference")
    @patch("pmagent.biblescholar.reference_slice.compute_verse_gematria")
    @patch("pmagent.biblescholar.reference_slice.BibleDbAdapter")
