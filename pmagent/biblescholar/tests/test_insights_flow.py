...
from pmagent.biblescholar.insights_flow import (
    VerseContext,
    format_context_for_llm,
    get_verse_context,
)
from pmagent.biblescholar.lexicon_adapter import LexiconEntry
...
class TestGetVerseContext:
    ...
    @patch("pmagent.biblescholar.insights_flow.fetch_verse")
    @patch("pmagent.biblescholar.insights_flow.fetch_word_study")
    @patch("pmagent.biblescholar.insights_flow.similar_verses_for_reference")
