...
from pmagent.biblescholar.lexicon_flow import (
    fetch_lexicon_entry,
    fetch_word_study,
    get_db_status,
    WordStudyResult,
...
class TestFetchLexiconEntry:
    ...
    @patch("pmagent.biblescholar.lexicon_flow.LexiconAdapter")
...
class TestFetchWordStudy:
    ...
    @patch("pmagent.biblescholar.lexicon_flow.LexiconAdapter")
    @patch("pmagent.biblescholar.lexicon_flow.parse_reference")
