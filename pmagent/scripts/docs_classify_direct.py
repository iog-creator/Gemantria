...
Usage:
    python pmagent/scripts/docs_classify_direct.py --canonical path1 path2 ...
    python pmagent/scripts/docs_classify_direct.py --archive path1 path2 ...
    python pmagent/scripts/docs_classify_direct.py --batch-review  # Review current batch
"""
