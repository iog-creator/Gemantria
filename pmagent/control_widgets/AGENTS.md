# AGENTS.md - pmagent/control_widgets Directory

## Directory Purpose

The `pmagent/control_widgets/` directory contains control_widgets components for the Gematria analysis pipeline.
