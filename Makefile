...
.PHONY: control.capability.rules.export
control.capability.rules.export:
...
.PHONY: atlas.lm.usage atlas.lm.health atlas.lm.insights atlas.lm.dashboards atlas.lm.status.html atlas.lm.dashboards.webproof atlas.lm.status.webproof
atlas.lm.usage:
...
atlas.lm.insights: atlas.lm.health
	@echo ">> Exporting LM Studio insights (7d)…"
	@PYTHONPATH=. python3 scripts/db/control_lm_insights_export.py
	@echo ">> LM insights exported to share/atlas/control_plane/lm_insights_7d.json"
...
guard.atlas:
	...
	@pytest -q agentpm/tests/atlas/test_atlas_auditjump_e29_e31.py > evidence/guard_atlas_auditjump.txt || (echo 'FAIL_guard.atlas'; exit 1)
...
m14.proofs:
	...
	echo "[M14] E67: drilldown links sample (HINT)"; \
...
control.summary.smoke:
	@echo "[control.summary.smoke] Aggregated control-plane summary via pmagent"
